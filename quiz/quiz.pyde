...
def draw():
    ...
    Text(slide_counter, 24, 0.01, 0.94, col=(0, 0, 0, 255)).draw()
    Text("Use arrow keys to navigate slides", 20, 0.01, 0.97, col=(0, 0, 0, 255)).draw()
    draw_queued_text()
...
def titleSlide(title, subtitle=""):
    ...
    if subtitle:
        ...
        queue_text(Text(subtitle, 36, 0.5, 0.55, col=(0, 0, 0, subtitle_alpha), h_align=CENTER, v_align=CENTER))
    else:
...
def sectionTitle(title, subtitle=""):
    ...
    if subtitle:
        queue_text(Text(subtitle, 32, 0.5, 0.55, col=(0, 0, 0), h_align=CENTER, v_align=CENTER))
